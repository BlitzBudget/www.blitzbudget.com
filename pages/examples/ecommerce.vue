                  ...
                  <div class="card card-refine card-plain">
                    <h4 class="card-title">
                      ...
                      <button
                        ...
                        title="Reset Filter"
                      >
                        <em class="arrows-1_refresh-69 now-ui-icons"></em>
                      </button>
                    </h4>
                    <collapse>
                      <collapse-item no-icon class="card-header">
                        ...
                        <span class="price-left pull-left"
                          >€{{ filters.priceRange[0] }}</span
                        >
                        <span class="price-right pull-right"
                          >€{{ filters.priceRange[1] }}</span
                        >
            ...
            <div class="col-md-6 px-0">
              ...
              >
                <div class="card-title text-left">
                  <h2>
                    <a href="#pablo">
                      The New York Times Todd Snyder and Raf Simons Party During
                      Men’s Fashion Week
                    </a>
                  </h2>
                </div>
                <div class="card-footer text-left">
                  <div class="stats">
                    <span>
                      <em class="now-ui-icons users_circle-08"></em>Emy Grace
                    </span>
                    <span>
                      <em class="now-ui-icons tech_watch-time"></em> June 6,
                      2017
                    </span>
                  </div>
                ...
                <div class="card card-fashion">
                  ...
                  <div class="card-body">
                    <div class="card-footer text-left">
                      <div class="stats">
                        <span>
                          <em class="now-ui-icons users_circle-08"></em>Jerry
                          McGregor
                        </span>
                        <span>
                          <em class="now-ui-icons tech_watch-time"></em> June
                          10, 2017
                        </span>
                      </div>
                    </div>
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <card type="product" plain>
                ...
                <p class="card-description">
                  The smooth woven-wool is water resistant to ensure you stay
                  pristine after a long-haul flight. Cut in a trim yet
