      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            >
              <tab-pane>
                <em slot="label" class="now-ui-icons design_image"></em>
                  ...
                  <div class="col-md-5 ml-auto mr-auto">
                    ...
                    >
                      ...
                      <p class="card-description text-white">
                        ...
                        rewarding way. It was a great project and I would be
              ...
              <tab-pane>
                <em slot="label" class="now-ui-icons location_world"></em>
      ...
      <div class="col-lg-6 col-md-10">
        <card type="contact" raised header-classes="text-center">
          ...
          <div class="row">
            ...
            <div class="col-md-6">
              <n-button type="success" round class="pull-right"
