...
(function scopeWrapper($) {
    ...
    // Mobile Menu Button
    let mobileMBtn = document.getElementById('mobileMenuButton');

    if (isEmpty(mobileMBtn)) {
        return;
    }

    mobileMBtn.addEventListener("click", function () {
...
(function scopeWrapper($) {
	...
	// Toast for mixin (Notification) If Swal is defined
